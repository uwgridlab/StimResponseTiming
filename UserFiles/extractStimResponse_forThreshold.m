...
condType = condType(1:140); % 139 to start, only did 139 train times?
condType = condType(1:139); % 139 to start, only did 139 train times?
...
button200msStimDiff = buttonLocs{uniqueCond==4};% - tactorLocsVec; started with 3
